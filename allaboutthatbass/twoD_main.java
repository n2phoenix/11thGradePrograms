    ...
    { 
        ...
        { 
            ...
            { 
                ...
                case 6:
                System.out.println ("From which row should the matrix be sorted in ascending order? ");
                int h = Integer.parseInt (in.readLine());
                matrix.sort (h);
                
                case 7:
                System.out.println ("From which row should the matrix be sorted in descending order?");
